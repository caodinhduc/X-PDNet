...
### We design a cross-task distillation module, which levarage the idea of PAD-Net with improvement allowing model adaptive with different scales of plane instance mask
![Network Architecture](/images/attention.png)
### We highlight problem of obtaining boundary from current groundtruth to design boundary preserving loss, 
![Network Architecture](/images/coarse.png)
### Then propose Depth Guide Boundary Preserving Loss, that alleviates the problem of imperfect instance ground truth
...
![Network Architecture](/images/result1.png)
